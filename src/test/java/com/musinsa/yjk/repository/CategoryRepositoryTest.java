...
class CategoryRepositoryTest {
    ...
    @Test
    public void findCategoryMinimumPriceTest() {
        ...
        for (CategoryMinPriceDTO dto : results) {
            ...
            System.out.println("최소 상품 가격 리스트: " + dto.getPrice());
            totalSum = totalSum.add(dto.getPrice());
    ...
    @Test
    public void findBrandCategoryMinimumPricesTest() {
        ...
        Assertions.assertFalse(brandCategoryMinimumPrices.isEmpty());

        BigDecimal totalSum = BigDecimal.ZERO;
        for (CategoryMinPriceDTO dto : brandCategoryMinimumPrices) {
            System.out.println("카테고리 이름 리스트: " + dto.getCategoryName());
            System.out.println("브랜드 이름 리스트: " + dto.getBrandName());
            System.out.println("최소 상품 가격 리스트: " + dto.getPrice());
            totalSum = totalSum.add(dto.getPrice());
        ...
        System.out.println("totalSum : " + totalSum);
        Assertions.assertEquals(totalSum.compareTo(BigDecimal.valueOf(36100)), 0);
    }
}